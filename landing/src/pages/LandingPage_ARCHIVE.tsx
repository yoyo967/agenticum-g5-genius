...
function useSEO() {
  useEffect(() => {
    ...
    setMeta('description', 'The world\'s first voice-activated AI marketing operating system. 8 specialized agents, Gemini 3.1 Pro Live API, Imagen 3, EU AI Act compliant. Speak a command — the swarm delivers. Engineered for the Google Gemini Live Agent Challenge 2026.');
    ...
    setMeta('og:description', '8 Specialized AI Agents. One Voice. Infinite Synergy. Built on Gemini 3.1 Pro & Google Cloud.', true);
      ...
      '@graph': [
        {
          ...
          description: 'Autonomous voice-commanded multi-agent AI system for global enterprise marketing. Features real-time orchestration via Gemini 3.1 Pro Live API.',
          ...
          featureList: [
            'Voice-commanded agent orchestration via Gemini 3.1 Pro Live API (Low Latency)',
            ...
            'Google Search grounding for zero-hallucination factual integrity (Powered by Gemini 3.1 Pro)',
          ],
        },
        {
          '@type': 'Organization',
...
export function LandingPage() {
  ...
  const navLinks = [
    ...
    { 
      label: 'DEMO', 
      id: 'demo', 
      className: 'animate-pulse text-cyan-400 ring-1 ring-cyan-400 px-2 rounded' 
    },
  ];
            ...
            <div className="hidden md:flex items-center gap-8">
              {navLinks.map(link => (
                <button key={link.id} 
                  ...
                  className={link.className || `font-mono text-xs hover:text-accent transition-all uppercase tracking-wider relative group ${
                    link.id === 'demo' 
        ...
        <header id="mission" className="relative min-h-screen flex flex-col items-center justify-center text-center px-6 pt-32 pb-20 overflow-hidden">
          ...
          <motion.div style={{ opacity: heroOpacity, scale: heroScale }} className="flex flex-col items-center relative z-20 w-full max-w-7xl">
            ...
            <motion.p initial={{ opacity: 0 }} animate={heroVisible ? { opacity: 1 } : {}} transition={{ delay: 0.6 }}
              ...
              <span className="text-white/40"> via the Gemini 3.1 Pro Live Fabric.</span>
            </motion.p>
            <motion.p initial={{ opacity: 0 }} animate={heroVisible ? { opacity: 1 } : {}} transition={{ delay: 0.7 }}
              ...
              100% Google Cloud · Gemini 3.1 Pro · Vertex AI · Imagen 3 · EU AI Act Compliant
            </motion.p>
            ...
            <motion.div initial={{ opacity: 0 }} animate={heroVisible ? { opacity: 1 } : {}} transition={{ delay: 0.8 }}
              ...
              {[
                ...
                { icon: <Cpu size={16} />, label: 'Gemini 3.1 Pro', color: '#00FF88' },
            ...
            <div className="relative z-10">
              ...
              <div className="mt-12 pt-8 border-t border-white/5 grid grid-cols-2 md:grid-cols-4 gap-6">
                {[
                  ...
                  { label: 'Cloud Run Revision', value: '00036' },
                ].map(m => (
          ...
          <div className="grid grid-cols-1 md:grid-cols-12 gap-5">
            ...
            <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }}
              ...
              <div className="flex items-center gap-3 mb-6">
                ...
                <span className="label-active">Gemini 3.1 Pro · Live API · Function Calling</span>
              </div>
              ...
              <p className="text-white/40 text-sm max-w-lg font-mono leading-relaxed">
                You speak — Gemini 3.1 Pro identifies your intent via Function Calling and triggers all 8 agents
            ...
            <motion.div initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }}
              ...
              <div className="relative z-10">
                ...
                <div className="flex flex-wrap justify-center gap-3 max-w-4xl mx-auto">
                  {[
                    '100% Original Code', 'Google Cloud Native', 'Gemini 3.1 Pro Exp',
            ...
            <div className="flex flex-col md:flex-row justify-between items-start gap-16 mb-16">
              ...
              <div className="flex flex-col gap-5 max-w-sm">
                ...
                <div className="flex flex-wrap gap-2">
                  {['Gemini 3.1 Pro', 'Vertex AI', 'Cloud Run'].map(t => (
              ...
              <div className="grid grid-cols-2 lg:grid-cols-3 gap-10">
                ...
                <div className="flex flex-col gap-3">
                  ...
                  {['sn00 · Orchestrator', 'sp01 · Strategist', 'cc06 · Copywriter', 'da03 · Design AI', 'ba07 · Deep Intel', 've01 · Motion', 'ra01 · Senate', 'ga01 · Grounding'].map(a => (
            ...
            <div className="pt-8 border-t border-white/5 flex flex-col md:flex-row items-center justify-between gap-4">
              <div className="flex flex-col gap-1">
                <p className="font-mono text-[9px] text-white/20 uppercase tracking-[0.2em]">
                  CLOUD RUN REVISION: AGENTICUM-FRONTEND-00036 // 01.03.2026 11:20 CET
                </p>
