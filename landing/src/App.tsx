...
import { Bot, Image as ImageIcon, Sparkles, BookOpen, Mic2 } from 'lucide-react';
      ...
      <div className="relative z-10 spatial-depth">
        ...
        >
          ...
          <div className="flex items-center gap-6">
            <button className="text-[10px] font-black uppercase tracking-widest text-white/30 hover:text-white transition-colors">Login</button>
            <button className="bg-white text-obsidian px-6 py-2 rounded-lg text-[10px] font-black hover:bg-neural-blue transition-all active:scale-95 uppercase tracking-widest">
              Initiate Contact
            </button>
          </div>
        </motion.nav>
        ...
        <header className="relative pt-64 pb-32 px-6 max-w-7xl mx-auto flex flex-col items-center text-center">
          ...
          {/* Floating UI Module: Orchestration */}
          <motion.div 
            id="synergy"
            style={{ y: yRange }}
            className="w-full max-w-6xl floating-module glass p-1 rounded-xl shadow-[0_100px_200px_rgba(0,0,0,0.9)] border-white/5"
          >
