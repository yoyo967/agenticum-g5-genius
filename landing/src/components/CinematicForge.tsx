...
import { Video, Film, Sparkles, Play, Music, ChevronRight, RefreshCw, Layers } from 'lucide-react';
                    ...
                    <div className="space-y-6">
                       <div className="space-y-2">
                          ...
                          <div className="p-4 bg-white/5 rounded-xl border border-white/5">
                             ...
                             <p className="text-[11px] text-white/50 leading-relaxed">Dynamic lens movements with cinematic high-contrast lighting. Optimized for promotional distribution.</p>
                          </div>
                       </div>
                       <div className="flex gap-3 pt-6">
                         ...
                         <button className="btn btn-ghost btn-sm px-3 border-white/10"><ChevronRight size={14} /></button>
                       </div>
                    </div>
                  </motion.div>
                </AnimatePresence>
